...
export const siteContent = {
  ...
  hero: {
    ...
    baseline: "Vous êtes de ceux qui écrivent l'histoire ?<br>Ça tombe bien on est de ceux qui la racontent.",
  ...
  projects: {
    ...
    allTitle: "Toutes nos réalisations",
    viewAllLabel: "Voir tous nos projets",
